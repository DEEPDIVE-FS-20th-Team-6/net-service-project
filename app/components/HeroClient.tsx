      ...
      <div className='absolute bottom-[22%] sm:bottom-[24%] md:bottom-[28%] left-0 px-12 md:px-16 z-10'>
        <div className='max-w-lg'>
          ...
          <div className='flex gap-3 mt-5'>
            <button type="button" className='inline-flex items-center gap-2 rounded px-5 py-2 bg-white text-black font-semibold hover:bg-white/80 transition text-sm md:text-base'>
              <Play size={20} fill='black' />
              재생
            </button>
            <button type="button" className='inline-flex items-center gap-2 rounded px-5 py-2 bg-gray-500/70 text-white font-semibold hover:bg-gray-500/50 transition text-sm md:text-base'>
              <Info size={20} />
              상세 정보
            </button>
          </div>
